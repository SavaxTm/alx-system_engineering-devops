...
6-firstdirectory - Create a script that creates a directory named alx in the /tmp/ directory.

7-movethatfile - Move the file betty from /tmp/ to /tmp/alx.

8-firstdelete - Delete the file betty. The file betty is in /tmp/alx

9-firstdirdeletion - Delete the directory alx that is in the /tmp directory.
...
17-tree - Create a script that creates the directories welcome/, welcome/to/ and welcome/to/alx in the current directory. You are only allowed to use two spaces in your script, not more.
...
alx.mgc - Create a magic file alx.mgc that can be used with the command file to detect alx data files. alx  data files always contain the string ALX at offset 0
